...
SSP_PERSONNEL = {
    "Support": ["SCT RAYNEN", "PTE AIRUL", "REC ERWYN"],
    "Charlie": ["PTE RYAN", "SCT HONG KAI"],
    "Bravo": ["PTE QIU BIN", "SCT SYAWAL"],
    "MSC": ["SCT GARETH WONG QING YI", "PTE AIRUL IMAN"],
    "Alpha": ["PTE YUSOF"],
    "HQ": ["PTE MUHAMMAD SABRI BIN RAZALI", "PTE THENESH SARAVANAN", "CPL DEVANAND S/O GANESAN", "CPL DERRICK TAN JIAN HUI", "PTE NG CHIN SEK"],
}
